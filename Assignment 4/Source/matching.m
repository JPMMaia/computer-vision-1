function finalHomography = matching (image1, image2, matchingThreshold, distanceThreshold, iterationCount)
...
[matches, ~] = vl_ubcmatch(descriptors1, descriptors2, matchingThreshold);
